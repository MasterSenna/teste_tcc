...
function saveAndRedirect() {
    ...
    const redirectURL = `perfilmentorado.html?fullName=${encodeURIComponent(updatedFullName)}&role=${encodeURIComponent(updatedRole)}&place=${encodeURIComponent(updatedPlace)}`;
